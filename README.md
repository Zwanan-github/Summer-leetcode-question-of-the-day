...
### [合并二叉树 - 2023/8/14](https://leetcode.cn/problems/merge-two-binary-trees/description/)
    ...
    def mergeTrees(self, root1: Optional[TreeNode], root2: Optional[TreeNode]) -> Optional[TreeNode]:
        def dfs(root1: Optional[TreeNode], root2: Optional[TreeNode]) -> Optional[TreeNode]:
            if root1 != None and root2 != None:
                ...
                root1 = TreeNode(root2.val, root2.left, root2.right)
            elif root1 == None and root2 == None:
                root1 = None
            return root1
...
### [统计点对的数目 - 2023/8/23](https://leetcode.cn/problems/count-pairs-of-nodes/description/)
...
### [统计二叉树中好节点的数目 - 2023/8/25](https://leetcode.cn/problems/count-good-nodes-in-binary-tree/description/)
...
class Solution:
    def goodNodes(self, root: TreeNode) -> int:
        ans = 0
        def dfs(self, root: TreeNode, maxn: int):
            if root == None:
                return
            nonlocal ans
            if root.val >= maxn:
                ...
                ans += 1
            dfs(self, root.left, maxn)
            dfs(self, root.right, maxn)
        dfs(self, root, -1e5)
        return ans
```
...
### [一个图中连通三元组的最小度数 - 2023/8/31](https://leetcode.cn/problems/minimum-degree-of-a-connected-trio-in-a-graph/)
